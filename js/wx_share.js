	...
	$.post(url,function(msg){
		if(msg.start == 0){
          return alert(msg.message);
			...
			var title ='老司机飙车不可怕 就怕汽车有文化'; // 分享标题
            var link ='https://h5.xingyuanauto.com/201705/CarCultural/index.html';
            var desc = '没想到你是这样的小漫画！'; // 分享描述
            var imgUrl = 'https://h5.xingyuanauto.com/201705/CarCultural/img/share.jpg';
